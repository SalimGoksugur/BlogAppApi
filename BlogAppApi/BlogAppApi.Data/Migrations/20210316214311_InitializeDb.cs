    ...
    public partial class InitializeDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecurityCodes", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentSummary = table.Column<string>(type: "varchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "Identity ile Kimlik Doğrulama" },
                    { 5, "JWT Authorization" },
                    { 6, "Frontend Programlama" },
                    { 7, "Katmanlı mimari" },
                    { 8, "Restful servisler" }
                });
